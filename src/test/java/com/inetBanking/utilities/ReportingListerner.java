...
public class ReportingListerner extends TestListenerAdapter {

	public ExtentHtmlReporter htmlReporter;  //--> depercated 
	//public ExtentSparkReporter spark;    --> New Alternative Need to Update
	...
	public void onStart(ITestContext testContext){
		...
		extent.setSystemInfo("user","Shiva Prasad");
